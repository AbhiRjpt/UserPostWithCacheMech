    ...
    public Response createFailureResponse(Exception e, OrgResponseData orgResponseData) {
        ...
        if(e instanceof InternalException){
            ...
            switch (ed.getHttpErrorCode()){
                ...
                case InternalErrorCodes.ARTICLE_CREATION_FAILED:
                case InternalErrorCodes.ARTICLE_UPDATION_FAILED:
                case InternalErrorCodes.POST_CREATION_FAILED:
                case InternalErrorCodes.POST_UPDATION_FAILED:
                ...
                case InternalErrorCodes.INVALID_POST_ID:
                case InternalErrorCodes.INVALID_ARTICLE_ID:
